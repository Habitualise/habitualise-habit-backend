...
class HabitController(private val pipeline: Pipeline) {
    ...
    @PostMapping
    fun createHabit(@RequestBody createHabitRequest: CreateHabitRequest): ResponseEntity<UUID> {
        ...
        return if (createHabitResult.isSuccess) {
            ...
            logger.error("An exception occurred when creating a habit", createHabitResult.exceptionOrNull())
